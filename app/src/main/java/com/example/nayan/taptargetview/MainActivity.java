package com.example.nayan.taptargetview;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Rect droidTarget = new Rect(0, 0, droid.getIntrinsicWidth() * 12, droid.getIntrinsicHeight() * 12);
        // Using deprecated methods makes you look way cool
        droidTarget.offset(display.getWidth() / 12, display.getHeight() / 12);
        ...
        final SpannableString sassyDesc2 = new SpannableString("It allows Nayan to go back, sometimes");
        sassyDesc2.setSpan(new UnderlineSpan(), 10, 10 + "Nayan".length(), 0);
        ...
        final TapTargetSequence sequence = new TapTargetSequence(this)
                .targets(
                        ...
                        TapTarget.forBounds(droidTarget, "Oh look!", "You can point to any part of the screen. You also can't cancel this one!")
                                ...
                                .icon(droid)
                                .id(2),
                        TapTarget.forView(findViewById(R.id.educated), "Oh Nayan!", sassyDesc2)
                                .cancelable(false)
